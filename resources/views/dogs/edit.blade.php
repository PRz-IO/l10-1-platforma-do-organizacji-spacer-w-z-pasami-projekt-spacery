<x-layout>
    <div class="container">
        <h1 style="margin-bottom:20px;color:#2f2f2f;font-size:26px;font-weight:700;letter-spacing:.2px;text-align:left;">Edytuj psa</h1>
      ...
      style="display:flex;flex-direction:column;gap:12px;text-align:left;">
            ...
            <div>
                ...
                <textarea name="Behaviour"
                          style="
                                    ...
                                    "
                            onfocus="this.style.borderColor='#c9d6ea'"
                            onblur="this.style.borderColor='#e2e2e2'">{{ $dog->Behaviour }}</textarea>
            </div>
            ...
            <div>
                ...
                <select name="State" style="
                                        ...
                                        onfocus="this.style.borderColor='#c9d6ea'"
                                        onblur="this.style.borderColor='#e2e2e2'">
                    <option value="Ready" @selected($dog->State === 'Ready')>Gotowy na spacer</option>
                    <option value="Sick" @selected($dog->State === 'Sick')>Pod opieką weterynarza</option>
                    <option value="Difficult" @selected($dog->State === 'Difficult')>Wymaga doświadczonej opieki</option>
                    <option value="Dead" @selected($dog->State === 'Dead')>W lepszym miejscu</option>
                </select>
            </div>
